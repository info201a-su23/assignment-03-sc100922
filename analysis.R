...
plot(national$date, national$new_cases)

plot(national$date, national$new_deaths)
...
# From this data, what is the average number of new cases of COVID-19 per day
# for the entire country in 2022?

#  Write code (at least 2-3 lines) that will answer your question
my_answer <- national %>%
  filter(year(date) == 2022) %>%
  summarize(average_new_cases = mean(new_cases))
print(my_answer)
